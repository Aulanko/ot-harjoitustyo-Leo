...
class MainWindow(QMainWindow):
    ...
    def setupUI(self):
        ...
        self.basic_info_text.setPlaceholderText(
            "Stock info logs will appear here")
        right_layout.addWidget(self.basic_info_text, 0, 1)

        # right_layout.addWidget(Color("green"), 1, 0)
        self.basic_analysis_text = QTextEdit()
        self.basic_analysis_text.setPlaceholderText(
            "Stock analysis info will appear here")
    ...
    def load_data(self):
        ...
        fig = visual.make_a_graph_from_prices(
            stock_data_for_plotting, "High", first_symbol)
